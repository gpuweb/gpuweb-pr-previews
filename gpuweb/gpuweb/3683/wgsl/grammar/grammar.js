...
module.exports = grammar({
    ...
    rules: {
        ...
        diagnostic_directive: $ => seq($.diagnostic, $.diagnostic_control, $.semicolon),
        literal: $ => choice(
            $.int_literal,
            $.float_literal,
            $.bool_literal
        ...
        attribute: $ => choice(
            ...
            seq($.attr, token('diagnostic'), $.diagnostic_control),
        ...
        diagnostic_control: $ => seq($.paren_left, $.severity_control_name, $.comma, $.diagnostic_rule_name, $.attrib_end),
