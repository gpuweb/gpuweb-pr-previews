...
module.exports = grammar({
    ...
    rules: {
        ...
        attribute: $ => choice(
            seq($.attr, $.align, $.paren_left, $.expression, $.attrib_end),
            seq($.attr, $.binding, $.paren_left, $.expression, $.attrib_end),
            seq($.attr, $.builtin, $.paren_left, $.builtin_value_name, $.attrib_end),
            seq($.attr, $.const),
            seq($.attr, $.group, $.paren_left, $.expression, $.attrib_end),
            seq($.attr, $.id, $.paren_left, $.expression, $.attrib_end),
            seq($.attr, $.interpolate, $.paren_left, $.interpolation_type_name, $.attrib_end),
            seq($.attr, $.interpolate, $.paren_left, $.interpolation_type_name, $.comma, $.interpolation_sample_name, $.attrib_end),
            seq($.attr, $.invariant),
            seq($.attr, $.location, $.paren_left, $.expression, $.attrib_end),
            seq($.attr, $.size, $.paren_left, $.expression, $.attrib_end),
            seq($.attr, $.workgroup_size, $.paren_left, $.expression, $.attrib_end),
            seq($.attr, $.workgroup_size, $.paren_left, $.expression, $.comma, $.expression, $.attrib_end),
            seq($.attr, $.workgroup_size, $.paren_left, $.expression, $.comma, $.expression, $.comma, $.expression, $.attrib_end),
            seq($.attr, $.vertex),
            seq($.attr, $.fragment),
            seq($.attr, $.compute)
        ),
        ...
        size: $ => token('size'),
        vertex: $ => token('vertex'),
        workgroup_size: $ => token('workgroup_size'),
